...
*/
void ParserBase::getTextWithinItem(pugi::xml_node node, string &text)
{
...
*/
vector<string> ParserBase::split(const string &s, const string &delim)
{
...
*/
vector<string> ParserBase::splitIntoSentences(const string &s)
{
